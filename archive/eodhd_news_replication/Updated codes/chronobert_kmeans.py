...
Step 1:
    ...
    - Clean text (remove URLs / boilerplate / platform names)
...
OUTPUT_PARQUET_PATH = "news_with_topics.parquet"
SYMBOL_FILTER = ["AAPL.US", "MSFT.US", "AMZN.US", "GOOGL.US", "TSLA.US", "META.US", "NVDA.US"]  # change this per ticker or parametrize later
...
def clean_text(text: str) -> str:
    """
    Lightly clean raw article text before feeding into ChronoBERT:
      - remove URLs and bare domains
      - remove obvious UI / boilerplate phrases
      - remove some platform names
    We keep the main financial content intact.
    """
