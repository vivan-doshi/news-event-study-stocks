...
class TextPreprocessor:
    ...
    def build_vocabulary(self, df: pd.DataFrame) -> Dict[str, int]:
        ...
        vocab_df.to_csv("config/vocabulary.csv", index=False)
        ...
        with open("config/vocabulary.yaml", 'w') as f:
    ...
    def process_pipeline(self, input_file: str = None) -> Tuple[pd.DataFrame, Dict[str, int]]:
        ...
        # Save processed data
        output_file = "data/processed/news_clean.parquet"
        ...
        with open("data/outputs/logs/preprocessing_stats.json", 'w') as f:
