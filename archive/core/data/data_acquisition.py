...
class EODHDDataAcquisition:
    ...
    def __init__(self, api_key: Optional[str] = None, config_path: str = "config/experiment.yaml"):
        ...
        Path("data/outputs/logs").mkdir(parents=True, exist_ok=True)
    ...
    def fetch_all_news(self, symbols: Optional[List[str]] = None) -> pd.DataFrame:
        ...
        if symbols is None:
            ...
            with open("config/symbols_us.txt", 'r') as f:
    ...
    def calculate_returns(self, prices_df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Save returns data
        returns_df.to_parquet("data/processed/returns_daily.parquet", compression='snappy')
        ...
        monthly_returns.to_parquet("data/processed/returns_monthly.parquet", compression='snappy')
    ...
    def _log_statistics(self, df: pd.DataFrame):
        ...
        with open("data/outputs/logs/data_acquisition_stats.json", 'w') as f:
        ...
        if not df.empty and 'published_at' in df.columns:
            ...
            if missing_dates:
                ...
                with open("data/outputs/logs/missing_coverage_dates.txt", 'w') as f:
