...
class PredictiveModels:
    ...
    def load_panel_data(self, frequency: str = 'monthly', method: str = 'mean',
        ...
        if not Path(panel_file).exists():
            ...
            panel_file = f"data/processed/panel_{frequency}_{method}_batch.parquet"
    ...
    def plot_impulse_responses(self, var_results: Dict, output_dir: str = "data/outputs/results/irf_plots"):
...
def run_predictive_models_pipeline() -> Dict:
    ...
    # Save predictions
    predictions.to_parquet("data/outputs/results/predictions_oos.parquet")
    predictions.to_csv("data/outputs/results/predictions_oos.csv")

    # Calculate trading performance
    performance = models.calculate_trading_performance(predictions)

    # Save performance metrics
    with open("data/outputs/results/trading_performance.json", 'w') as f:
    ...
    with open("data/outputs/results/var_summary.json", 'w') as f:
    ...
    plt.tight_layout()
    plt.savefig("data/outputs/results/equity_curve.png", dpi=100)
    plt.close()
